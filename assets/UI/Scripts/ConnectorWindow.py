...
class Ui_Connector(object):
    def setupUi(self, Connector):
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 331, 261))
        font = QtGui.QFont()
...
" min-height: 20px;")
        ...
        self.trusted.setGeometry(QtCore.QRect(241, 150, 70, 30))
        font = QtGui.QFont()
        ...
        self.buffered.setGeometry(QtCore.QRect(241, 110, 70, 30))
        font = QtGui.QFont()
        font.setFamily("Arial,Helvetica,sans-serif")
        font.setPointSize(8)
        font.setBold(False)
