...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.tabs.setMinimumSize(QtCore.QSize(801, 631))
        ...
        self.label.setMinimumSize(QtCore.QSize(719, 22))
        ...
        self.console_out.setMinimumSize(QtCore.QSize(800, 72))
        font = QtGui.QFont()
        font.setFamily("Arial,Helvetica,sans-serif")
        font.setPointSize(12)
