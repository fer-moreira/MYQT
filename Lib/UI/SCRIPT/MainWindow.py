...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(280, 2, 760, 610))
        font = QtGui.QFont()
        ...
        self.query_in.setStyleSheet("border:1 solid darkred;")
        ...
        self.console_out.setGeometry(QtCore.QRect(280, 620, 756, 130))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.console_out.setStyleSheet("background-color:rgb(248,248,248)")
        ...
        self.createdb_btn.setGeometry(QtCore.QRect(190, 713, 78, 40))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.createdb_in.setGeometry(QtCore.QRect(10, 713, 180, 40))
        font = QtGui.QFont()
        font.setFamily("Consolas")
