...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(193, 0, 710, 614))
        font = QtGui.QFont()
        ...
        self.desc_result.setGeometry(QtCore.QRect(0, 0, 710, 590))
        ...
        self.data_result.setGeometry(QtCore.QRect(0, 0, 710, 590))
        ...
        self.result_out.setGeometry(QtCore.QRect(0, 290, 710, 290))
        ...
        self.query_in.setGeometry(QtCore.QRect(0, 10, 710, 270))
        font = QtGui.QFont()
        ...
        self.query_in.setPlainText("select * from [table]")
        ...
        self.console_out.setGeometry(QtCore.QRect(193, 630, 710, 80))
        font = QtGui.QFont()
        ...
        self.tables_out.setGeometry(QtCore.QRect(10, 24, 170, 686))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setItalic(False)
    ...
    def retranslateUi(self, SQLMANAGER):
        ...
        self.console_out.setPlainText(_translate("SQLMANAGER", "[ Console ]"))
