...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        SQLMANAGER.resize(1048, 800)
        SQLMANAGER.setMinimumSize(QtCore.QSize(0, 0))
        SQLMANAGER.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.data_result.setGeometry(QtCore.QRect(0, 1, 740, 617))
        ...
        self.desc_result.setGeometry(QtCore.QRect(0, 310, 740, 307))
        ...
        self.create_in.setGeometry(QtCore.QRect(0, 1, 740, 303))
        font = QtGui.QFont()
        ...
        self.line_2.setGeometry(QtCore.QRect(0, 300, 740, 10))
        ...
        self.result_out.setGeometry(QtCore.QRect(0, 310, 740, 308))
        ...
        self.query_in.setGeometry(QtCore.QRect(0, 2, 740, 301))
        ...
        self.line.setGeometry(QtCore.QRect(0, 295, 744, 20))
        ...
        self.tables_out.setMinimumSize(QtCore.QSize(260, 590))
        self.tables_out.setMaximumSize(QtCore.QSize(260, 590))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.gridLayout.addWidget(self.tables_out, 0, 1, 1, 3)
        self.createdb_in = QtWidgets.QLineEdit(self.centralwidget)
        self.createdb_in.setMinimumSize(QtCore.QSize(180, 40))
        self.createdb_in.setMaximumSize(QtCore.QSize(180, 40))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.createdb_in.setFont(font)
        self.createdb_in.setObjectName("createdb_in")
        self.gridLayout.addWidget(self.createdb_in, 1, 1, 1, 1)
        self.createdb_btn = QtWidgets.QPushButton(self.centralwidget)
        self.createdb_btn.setMinimumSize(QtCore.QSize(77, 40))
        self.createdb_btn.setMaximumSize(QtCore.QSize(77, 40))
        ...
        self.createdb_btn.setAcceptDrops(False)
        ...
        self.gridLayout.addWidget(self.createdb_btn, 1, 2, 1, 2)
        self.console_out = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.console_out.setMinimumSize(QtCore.QSize(1000, 80))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.gridLayout.addWidget(self.console_out, 2, 0, 1, 3)
        self.openConsole = QtWidgets.QPushButton(self.centralwidget)
        self.openConsole.setMaximumSize(QtCore.QSize(30, 80))
        font = QtGui.QFont()
        font.setKerning(True)
...
"border-bottom-right-radius:20px;")
        ...
        self.gridLayout.addWidget(self.openConsole, 2, 3, 1, 1)
        self.tabs.raise_()
