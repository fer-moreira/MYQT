...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(280, 2, 762, 612))
        font = QtGui.QFont()
        ...
        self.desc_result.setGeometry(QtCore.QRect(0, 0, 760, 580))
        ...
        self.data_result.setGeometry(QtCore.QRect(0, 0, 760, 580))
        ...
        self.result_out.setGeometry(QtCore.QRect(0, 300, 756, 278))
        ...
        self.query_in.setGeometry(QtCore.QRect(0, 0, 756, 297))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.tables_out.setGeometry(QtCore.QRect(10, 0, 260, 710))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.tables_out.setFont(font)
        self.tables_out.setAutoFillBackground(False)
        self.tables_out.setStyleSheet("margin:2")
        ...
        self.createdb_btn.setGeometry(QtCore.QRect(191, 710, 77, 40))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.createdb_in.setGeometry(QtCore.QRect(12, 711, 177, 38))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        SQLMANAGER.setTabOrder(self.tabWidget, self.query_in)
    ...
    def retranslateUi(self, SQLMANAGER):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self._desc), _translate("SQLMANAGER", "Fields"))
