...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(187, 10, 691, 580))
        font = QtGui.QFont()
        ...
        self.desc_result.setGeometry(QtCore.QRect(0, 0, 690, 546))
        ...
        self.data_result.setGeometry(QtCore.QRect(0, 0, 690, 546))
        ...
        self.result_out.setGeometry(QtCore.QRect(4, 270, 684, 270))
        ...
        self.console_out.setGeometry(QtCore.QRect(4, 590, 874, 110))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.tables_out.setGeometry(QtCore.QRect(7, 10, 177, 570))
        self.tables_out.setMaximumSize(QtCore.QSize(180, 570))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.tables_out.setFrameShape(QtWidgets.QFrame.Box)
        self.tables_out.setFrameShadow(QtWidgets.QFrame.Plain)
        self.tables_out.setLineWidth(1)
        ...
        SQLMANAGER.setTabOrder(self.tables_out, self.tabWidget)
    ...
    def retranslateUi(self, SQLMANAGER):
        ...
        self.desc_result.setToolTip(_translate("SQLMANAGER", "<html><head/><body><p>DATA DESCRIPTIONS</p></body></html>"))
        ...
        self.data_result.setToolTip(_translate("SQLMANAGER", "<html><head/><body><p>ALL DATA IN TABLE</p></body></html>"))
        ...
        self.result_out.setToolTip(_translate("SQLMANAGER", "<html><head/><body><p>RESULTS</p></body></html>"))
        ...
        self.console_out.setToolTip(_translate("SQLMANAGER", "<html><head/><body><p>CONSOLE</p></body></html>"))
        self.console_out.setPlaceholderText(_translate("SQLMANAGER", "CONSOLE"))
        self.tables_out.setToolTip(_translate("SQLMANAGER", "<html><head/><body><p>TABLES</p></body></html>"))
        self.tables_out.setSortingEnabled(True)
