...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(242, -2, 650, 581))
        font = QtGui.QFont()
        ...
        self.desc_result.setGeometry(QtCore.QRect(0, 2, 690, 540))
        ...
        self.data_result.setGeometry(QtCore.QRect(0, 2, 690, 540))
        ...
        self.result_out.setGeometry(QtCore.QRect(0, 270, 640, 273))
        ...
        self.query_in.setGeometry(QtCore.QRect(0, 0, 640, 271))
        font = QtGui.QFont()
        ...
        self.console_out.setGeometry(QtCore.QRect(10, 579, 874, 130))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.tables_out.setGeometry(QtCore.QRect(10, 10, 227, 560))
