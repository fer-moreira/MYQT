...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.tabs.setGeometry(QtCore.QRect(280, 2, 762, 612))
        ...
        self.desc_result.setGeometry(QtCore.QRect(0, 0, 760, 575))
        ...
        self.data_result.setGeometry(QtCore.QRect(0, 0, 760, 575))
        ...
        self.result_out.setGeometry(QtCore.QRect(0, 310, 756, 270))
        ...
        self.line.setGeometry(QtCore.QRect(0, 300, 760, 10))
        ...
        self.console_out.setGeometry(QtCore.QRect(280, 620, 758, 130))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.tables_out.setGeometry(QtCore.QRect(10, 10, 260, 690))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.tables_out.header().setCascadingSectionResizes(False)
        self.tables_out.header().setHighlightSections(True)
        self.createdb_btn = QtWidgets.QPushButton(self.centralwidget)
        self.createdb_btn.setGeometry(QtCore.QRect(191, 710, 77, 38))
        ...
        self.createdb_in.setGeometry(QtCore.QRect(12, 710, 177, 38))
        font = QtGui.QFont()
        font.setFamily("Consolas")
