...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.result_out.setGeometry(QtCore.QRect(0, 308, 756, 310))
        ...
        self.query_in.setGeometry(QtCore.QRect(0, 2, 756, 297))
        ...
        self.line.setGeometry(QtCore.QRect(0, 293, 760, 20))
        ...
        self.createdb_btn.setGeometry(QtCore.QRect(191, 601, 77, 38))
        ...
        self.createdb_in.setGeometry(QtCore.QRect(10, 601, 177, 38))
        font = QtGui.QFont()
        font.setFamily("Consolas")
