...
class Ui_Connector(object):
    def setupUi(self, Connector):
        ...
        self.title.setGeometry(QtCore.QRect(10, 14, 260, 20))
        font = QtGui.QFont()
        ...
        self.host_in.setStyleSheet("border:0;background-color:black;color:white;")
        ...
        self.user_in.setStyleSheet("border:0;background-color:black;color:white;")
        ...
        self.pass_in.setStyleSheet("border:0;background-color:black;color:white;")
        ...
        self.dbs.setStyleSheet("padding:8;border:0;background-color:black;color:white;")
