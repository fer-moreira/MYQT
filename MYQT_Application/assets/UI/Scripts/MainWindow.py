...
class Ui_SQLMANAGER(object):
    def setupUi(self, SQLMANAGER):
        ...
        self.gridLayout.addWidget(self.tables_out, 0, 0, 2, 1)
        ...
        self.data_result.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.data_result.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.data_result.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.data_result.setTabKeyNavigation(False)
        self.data_result.setProperty("showDropIndicator", True)
        self.data_result.setDragDropOverwriteMode(False)
        self.data_result.setAlternatingRowColors(True)
        self.data_result.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.data_result.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        ...
        self.desc_result.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        ...
        self.result_out.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        ...
        self.query_in.setMinimumSize(QtCore.QSize(0, 200))
        self.query_in.setMaximumSize(QtCore.QSize(16777215, 200))
        ...
        self.query_in.setFrameShape(QtWidgets.QFrame.WinPanel)
        self.query_in.setFrameShadow(QtWidgets.QFrame.Raised)
        self.query_in.setLineWidth(3)
        self.query_in.setMidLineWidth(3)
        ...
        SQLMANAGER.setTabOrder(self.result_out, self.tabs)
    ...
    def retranslateUi(self, SQLMANAGER):
        ...
        self.data_result.setSortingEnabled(True)
